class Epicli < Formula
  ...
  url "https://github.com/mainstreamer/config/releases/download/v4.0.0/epicli-4.0.0.tar.gz"
  sha256 "c5260850a53fb350a2e1f8078927e17eb507edfa43660d57509fcb695cec193c"
  license "MIT"
